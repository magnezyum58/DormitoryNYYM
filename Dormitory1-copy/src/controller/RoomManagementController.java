...
public class RoomManagementController implements Initializable {
    ...
    public void visibility() {
        ...
        if (this.mg.roomControl(bed1)) {
            ...
            this.nameSurnameText1.setText(this.mg.getNameSurname(bed1));
            this.studentNumberText1.setText(this.mg.studentId(bed1));
            this.tcNoText1.setText(this.mg.getTcNo(bed1));
        }
        if (this.mg.roomControl(bed2)) {
            ...
            this.nameSurnameText1.setText(this.mg.getNameSurname(bed2));
            this.studentNumberText1.setText(this.mg.studentId(bed2));
            this.tcNoText1.setText(this.mg.getTcNo(bed2));
        }
        if (this.mg.roomControl(bed3)) {
            ...
            this.nameSurnameText1.setText(this.mg.getNameSurname(bed3));
            this.studentNumberText1.setText(this.mg.studentId(bed3));
            this.tcNoText1.setText(this.mg.getTcNo(bed3));
        }
        if (this.mg.roomControl(bed4)) {
            ...
            this.nameSurnameText1.setText(this.mg.getNameSurname(bed4));
            this.studentNumberText1.setText(this.mg.studentId(bed4));
            this.tcNoText1.setText(this.mg.getTcNo(bed4));
        }
    }
